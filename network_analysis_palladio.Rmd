...
The instructions for options 1 and 2 are contained within this page, but to use the interactive notebook, you need to load an interactive environment called MyBinder. You can skip to the next section if you'd just like to get started with an easy-to-use web application.
