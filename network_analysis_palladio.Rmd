...
The instructions for options 1 and 2 are contained within this page, but to use the interactive notebook, you need to load an interactive environment called MyBinder. First, click here [give link to mybinder]
...
# Network visualisation with Palladio  
...
First, go to http://hdlab.stanford.edu/palladio/ in your browser, and click on the 'start' button.

![](dh_definitions_bot/Screen Shot 2021-05-23 at 18.06.57.png)
...
Click on the 'source' drop down, and select the 'author' option in the popup box:

![](dh_definitions_bot/Screen Shot 2021-05-23 at 18.18.01.png)

Click on the 'target' dropdown and select the 'recipient' option in the popup. 
