...
The instructions for options 1 and 2 are contained within this page, but to use the interactive notebook, you need to load an interactive environment called MyBinder. You can skip this section if you would prefer to stick to tools with a user-interface.
